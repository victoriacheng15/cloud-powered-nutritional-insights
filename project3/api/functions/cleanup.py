    ...
    try:
        ...
        for resource_id in resource_ids:
            try:
                ...
                api_versions = ["2025-05-01", "2024-12-01-preview", "2024-11-01", "2024-04-01-preview", "2023-07-01", "2021-04-01-preview", "2021-04-01"]
                poller = None
                
                for api_version in api_versions:
                    try:
                        poller = client.resources.begin_delete_by_id(resource_id, api_version=api_version)
